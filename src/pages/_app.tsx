			...
			<Head>
				{process.env.NEXT_PUBLIC_DEMO === 'true' &&
					<>
						...
						<meta property='og:image' content={`https://weather-please.app/api/og?title=Weather%20Please&description=${encodeURIComponent('Weather Please is a minimal new tab page that provides an outlook on current and future weather data.')}&token=3b17f4222d691811a5a75dfd7b26a2235a212840f526c39828a07117997f17a3`} />
						...
						<meta name='twitter:image' content={`https://weather-please.app/api/og?title=Weather%20Please&description=${encodeURIComponent('Weather Please is a minimal new tab page that provides an outlook on current and future weather data.')}&token=3b17f4222d691811a5a75dfd7b26a2235a212840f526c39828a07117997f17a3`} />
					</>
				}
				{process.env.NEXT_PUBLIC_DEMO !== 'true' &&
					<title>New tab</title>
